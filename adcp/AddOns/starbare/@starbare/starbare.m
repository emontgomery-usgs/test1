function theResult = StarBare(theDataFile, theMaskFile)

% StarBare/StarBare -- ADCP Data Browser.
%  StarBare('theDataFile', 'theMaskFile') opens
%   'theDataFile' of ADCP measurements and 'theMaskFile'
%   corresponding to it.  The "get/put" file-dialog is
%   invoked if no such filename is given, or if a wildcard is given.
%   The "starbare" object is returned or placed in
%   the caller's "ans".  It is also available as
%   "px(gcf)" whenever the "StarBare Browser" window
%   is frontmost.
%
% STARBARE WINDOW
%
% The "StarBare Browser" window offers slider-controls
...
% STARBARE MENUBAR
%
% The StarBare menubar is for selecting the variables
...
theStruct.itSelf = [];
self = class(theStruct, 'starbare', pxwindow('StarBare Browser', 'XY'));
%drawnow;
