% script do_findwdir.m
%  DO_FINDWDIR:  script to run findwdir and produce some plots

% script to remind myself how I did the ADCP wind dir stuff.
%   etm 2/7/08
% load a sample file (adcp2ep run on raw *wh000.cdf data)
%  using an already processed file doesn't get the same result, even if the
%  surface bins are lef in
